...
namespace NivesBrelihPhotography.Migrations.NbpContextMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NivesBrelihPhotography.DbContexts.NbpContext>
    {
        ...
        protected override void Seed(NivesBrelihPhotography.DbContexts.NbpContext context)
        {
            ...
            new List<Photo>()
            {
                new Photo() {PhotoId = 1, CommentsEnabled = true,PhotoTitle = "First Photo",PhotoText = "Super Photo First",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic1.jpg", Uploaded = DateTime.Now,IsOnFrontPage = true,PhotoAlbumId = 1},
                ...
                new Photo() {PhotoId = 4, CommentsEnabled = true,PhotoTitle = "Fourth Photo",PhotoText = "Super Photo Forth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic4.jpg", Uploaded = DateTime.Now.AddDays(3),IsOnFrontPage = true,PhotoAlbumId = 2},
                ...
                new Photo() {PhotoId = 9, CommentsEnabled = true,PhotoTitle = "Second Photo",PhotoText = "Super Photo Second",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic2.jpg", Uploaded = DateTime.Now.AddDays(22),IsOnFrontPage = true,PhotoAlbumId = 3},
                ...
                new Photo() {PhotoId = 11, CommentsEnabled = true,PhotoTitle = "Fourth Photo",PhotoText = "Super Photo Forth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic4.jpg", Uploaded = DateTime.Now.AddDays(213),IsOnFrontPage = true,PhotoAlbumId = 4},
                new Photo() {PhotoId = 12, CommentsEnabled = true,PhotoTitle = "Fifth Photo",PhotoText = "Super Photo Fifth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic5.jpg", Uploaded = DateTime.Now.AddDays(45),IsOnFrontPage = true,PhotoAlbumId = 20},
                new Photo() {PhotoId = 13, CommentsEnabled = true,PhotoTitle = "Sixth Photo",PhotoText = "Super Photo Sixth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic6.jpg", Uploaded = DateTime.Now.AddDays(66),IsOnFrontPage = true,PhotoAlbumId = 5},
                new Photo() {PhotoId = 14, CommentsEnabled = true,PhotoTitle = "Seventh Photo",PhotoText = "Super Photo Seventh",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic7.jpg", Uploaded = DateTime.Now.AddDays(87),IsOnFrontPage = true,PhotoAlbumId = 6},
                 new Photo() {PhotoId = 15, CommentsEnabled = true,PhotoTitle = "First Photo",PhotoText = "Super Photo First",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic1.jpg", Uploaded = DateTime.Now,IsOnFrontPage = true,PhotoAlbumId = 1},
                new Photo() {PhotoId = 16, CommentsEnabled = true,PhotoTitle = "Second Photo",PhotoText = "Super Photo Second",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic2.jpg", Uploaded = DateTime.Now.AddDays(1),IsOnFrontPage = true,PhotoAlbumId = 7},
                new Photo() {PhotoId = 17, CommentsEnabled = true,PhotoTitle = "Third Photo",PhotoText = "Super Photo Third",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic3.jpg", Uploaded = DateTime.Now.AddDays(2),IsOnFrontPage = true,PhotoAlbumId = 8},
                new Photo() {PhotoId = 18, CommentsEnabled = true,PhotoTitle = "Fourth Photo",PhotoText = "Super Photo Forth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic4.jpg", Uploaded = DateTime.Now.AddDays(3),IsOnFrontPage = true,PhotoAlbumId = 9},
                new Photo() {PhotoId = 19, CommentsEnabled = true,PhotoTitle = "Fifth Photo",PhotoText = "Super Photo Fifth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic5.jpg", Uploaded = DateTime.Now.AddDays(4),IsOnFrontPage = true,PhotoAlbumId = 10},
                new Photo() {PhotoId = 20, CommentsEnabled = true,PhotoTitle = "Sixth Photo",PhotoText = "Super Photo Sixth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic6.jpg", Uploaded = DateTime.Now.AddDays(15),IsOnFrontPage = true,PhotoAlbumId = 11},
                new Photo() {PhotoId = 21, CommentsEnabled = true,PhotoTitle = "Seventh Photo",PhotoText = "Super Photo Seventh",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic7.jpg", Uploaded = DateTime.Now.AddDays(7),IsOnFrontPage = true,PhotoAlbumId = 12},
                new Photo() {PhotoId = 22, CommentsEnabled = true,PhotoTitle = "First Photo",PhotoText = "Super Photo First",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic1.jpg", Uploaded = DateTime.Now.AddDays(19),IsOnFrontPage = true,PhotoAlbumId = 13},
                new Photo() {PhotoId = 23, CommentsEnabled = true,PhotoTitle = "Second Photo",PhotoText = "Super Photo Second",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic2.jpg", Uploaded = DateTime.Now.AddDays(22),IsOnFrontPage = true,PhotoAlbumId = 14},
                new Photo() {PhotoId = 24, CommentsEnabled = true,PhotoTitle = "Third Photo",PhotoText = "Super Photo Third",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic3.jpg", Uploaded = DateTime.Now.AddDays(442),IsOnFrontPage = true,PhotoAlbumId = 15},
                new Photo() {PhotoId = 25, CommentsEnabled = true,PhotoTitle = "Fourth Photo",PhotoText = "Super Photo Forth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic4.jpg", Uploaded = DateTime.Now.AddDays(213),IsOnFrontPage = true,PhotoAlbumId = 16},
                new Photo() {PhotoId = 26, CommentsEnabled = true,PhotoTitle = "Fifth Photo",PhotoText = "Super Photo Fifth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic5.jpg", Uploaded = DateTime.Now.AddDays(45),IsOnFrontPage = true,PhotoAlbumId = 17},
                new Photo() {PhotoId = 27, CommentsEnabled = true,PhotoTitle = "Sixth Photo",PhotoText = "Super Photo Sixth",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic6.jpg", Uploaded = DateTime.Now.AddDays(66),IsOnFrontPage = true,PhotoAlbumId = 18},
                new Photo() {PhotoId = 28, CommentsEnabled = true,PhotoTitle = "Seventh Photo",PhotoText = "Super Photo Seventh",PhotoUrl = "/Images/Photos/Thumbnail_Test/nbPic7.jpg", Uploaded = DateTime.Now.AddDays(87),IsOnFrontPage = true,PhotoAlbumId = 19},
